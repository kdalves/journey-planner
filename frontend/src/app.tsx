...
export function App() {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      <div className="max-w-3xl w-full spx-6 text-center space-y-10">
        ...
        <div className='space-y-4'>
          ...
          {isGuestsInputOpen && (
            ...
            <button onClick={openGuestModal} type="button" className="flex items-center gap-2 flex-1">
              ...
              <span className="text-zic-400 text-lg flex-1 text-left">Quem estará na viagem?</span>
            </button>
            <div className="w-px h-6 bg-zinc-800" />
            <button onClick={openGuestInput} className="bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400">
              Confirmar viagem
        ...
        <p className="text-sm text-zinc-500">
          ...
          com nosssos <a className="text-zinc-300 underline" href="a">termos de uso</a> 
          e <a className="text-zinc-300 underline" href="a">politicas de privacidade</a>.
        </p>
      </div>
